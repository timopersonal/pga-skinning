...
void VulkanExample::preparePipelines()
{
	...
	const std::array<VkPipelineShaderStageCreateInfo, 2> shaderStages = {
		loadShader(getShadersPath() + "dqs/skinnedmodel.vert.spv", VK_SHADER_STAGE_VERTEX_BIT),
		loadShader(getShadersPath() + "dqs/skinnedmodel.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT)};
